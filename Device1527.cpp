...
Device1527::Device1527(int pulseWidth, int pulseSlack, int minRepeats, const char* baseTopic) : Device() {
...
void Device1527::processPulse(long duration) {
...
void Device1527::publishTopic(Message* message, char* buffer, int maxLength) {
   snprintf(buffer, maxLength, "%s/%s", _baseTopic,  message->text);
}
