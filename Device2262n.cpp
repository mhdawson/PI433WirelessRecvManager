...
Device2262n::Device2262n(int pulseWidth, int pulseSlack, int minRepeats, const char* baseTopic) : Device() {
...
void Device2262n::publishTopic(Message* message, char* buffer, int maxLength) {
